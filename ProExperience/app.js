...
const translations = {
  en: {
    ...
    eco_item_4_desc: "Initial, progress, and final evaluations with unlimited use for teachers. A 60-min test measuring 4 skills from A0 to C1.",
  ...
  es: {
    ...
    eco_item_4_desc: "Evaluación inicial, de progreso y final con uso ilimitado para docentes. Prueba de 60 min que evalúa 4 habilidades desde A0 hasta C1.",
