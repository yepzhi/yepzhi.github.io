...
const translations = {
  en: {
    ...
    eco_item_1_btn: "See more",
    tailored_books_title_1: "Tailored",
    tailored_books_title_2: "Formats",
    tailored_books_desc: "Explore our flagship series designed to adapt to higher education environments.",
    eco_books_eid_desc: "English ID 3.0 is a youthful and innovative approach featuring <strong>Pink Stress Letters</strong>, songs, and content that connects with the identity of young adult students.",
    eco_books_pb_desc: "Personal Best 2.0 is designed for high academic loads and the most demanding schools, focusing on intensive language production.",
    ...
    eco_item_4_desc: "Initial, progress, and final evaluations with unlimited use for teachers. A 60-min test evaluating listening, reading + grammar, from A0 to C1.",
    ...
    cert_btn_single: "View Certificate",
    ...
    testimonial_2_text: "\"The collaboration with Richmond has strengthened English teaching at our university, providing faculty and students with innovative resources that enrich learning and foster competency development for a global environment.\"",
    testimonial_2_author_name: "Claudia Beltrán López",
    testimonial_2_author_role: "President of the Institutional English Academy (UTH)",
    testimonial_3_text: "\"At the Technological University of Nogales, our collaboration with Richmond Pro has significantly strengthened the development of our students' English communicative skills. Their methodology, ongoing guidance, and technology tools have enabled us to advance toward higher quality education, aligned with international standards and industry needs.\"",
    testimonial_3_author_name: "Claudia Tapia",
    testimonial_3_author_role: "Technological University of Nogales (UTN)",
  ...
  es: {
    ...
    eco_item_1_btn: "Ver más",
    tailored_books_title_1: "Formatos",
    tailored_books_title_2: "a Medida",
    tailored_books_desc: "Conoce nuestras series principales diseñadas para adaptarse al entorno de educación superior.",
    eco_books_eid_desc: "English ID 3.0 es un enfoque juvenil e innovador con <strong>Pink Stress Letters</strong>, canciones y contenido que conecta con la identidad de los estudiantes jóvenes adultos.",
    eco_books_pb_desc: "Personal Best 2.0 está diseñado para una carga académica alta y las escuelas más exigentes, enfocándose en la producción del lenguaje de manera intensiva.",
    ...
    eco_item_4_desc: "Evaluación inicial, de progreso y final con uso ilimitado para docentes. Prueba de 60 min que evalúa listening, reading + grammar, desde A0 hasta C1.",
    ...
    cert_btn_single: "Ver Certificado",
    ...
    testimonial_2_text: "\"La colaboración con Richmond ha fortalecido la enseñanza del inglés en nuestra universidad, brindando a docentes y estudiantes recursos innovadores que enriquecen el aprendizaje y favorecen el desarrollo de competencias para un entorno global.\"",
    testimonial_2_author_name: "Claudia Beltrán López",
    testimonial_2_author_role: "Presidenta de la Academia Institucional de Inglés (UTH)",
    testimonial_3_text: "\"En la Universidad Tecnológica de Nogales, la colaboración con Richmond Pro ha fortalecido significativamente el desarrollo de las competencias comunicativas en inglés de nuestros estudiantes. Su metodología, acompañamiento y herramientas tecnológicas nos han permitido avanzar hacia una formación de mayor calidad, alineada con estándares internacionales y con las necesidades del sector productivo.\"",
    testimonial_3_author_name: "Claudia Tapia",
    testimonial_3_author_role: "Universidad Tecnológica de Nogales (UTN)",
      ...
      lightboxContent.innerHTML = `
        <div style="padding: 2.5rem 2rem; text-align: center; color: #fff; max-width: 480px; margin: 0 auto; background: rgba(15, 23, 42, 0.95); border: 1px solid rgba(245, 158, 11, 0.4); border-radius: 20px; box-shadow: 0 20px 50px rgba(0,0,0,0.7);">
          ...
          <h3 style="font-size: 1.7rem; margin: 1.2rem 0 0.5rem; color: #fff; font-family: var(--font-head);">
            ${isEn ? 'ITESCA Inauguration' : 'Inauguración ITESCA'}
          </h3>
