...
const TEAM = [
  {
    ...
    wa: '5216621147374',
    foto: 'assets/team/Alberto yepiz.png',
  ...
  },
  {
    ...
    nombre: 'Luis Franco',
    wa: '5218119905772',
    foto: 'assets/team/luis Franco.jpg',
  ...
  },
  {
    ...
    wa: '5213316025928',
    foto: 'assets/team/Fabiola Martinez.png',
  ...
  },
  {
    ...
    wa: '5215537339886',
    foto: 'assets/team/Arturo Mendoza.png',
  ...
  },
  {
    ...
    nombre: 'Joel Navor',
    wa: '522211057576',
    foto: 'assets/team/Joel Navor.jpg',
  ...
  },
  {
    ...
    wa: '526641234572',
    foto: 'assets/team/Edgar Espinoza.jpg',
  ...
  },
  {
    ...
    wa: '5215537339631',
    foto: 'assets/team/Daniel Morales.png',
    estados: ['Ciudad de México', 'Estado de México'],
    color: '#818cf8',
  },
  {
    ...
    zona: 'Zona CDMX',
    zonaShort: 'CDMX',
    nombre: 'Yanzer Rebollo',
    rol: 'Académico Richmond Pro',
    wa: '5215666689003',
    foto: 'assets/team/yanser Rebollo.png',
...
const MANAGERS = [
  { nombre: 'Michelle Gutiérrez', rol: 'Gerente México Sur', wa: '5215532239128', foto: 'assets/team/michelle Gutierrez.jpg' },
  { nombre: 'Marco Guerrero', rol: 'Gerente México Norte', wa: '5215666689044' },
  { nombre: 'Manuel Ramírez', rol: 'Gerente Nacional', wa: '5215539000043', highlight: true, foto: 'assets/team/Manuel Ramirez.png' },
];
...
function renderTeamSection() {
  ...
  section.innerHTML = `
    <div class="team-header">
      ...
      <h2 class="team-title">Equipo Richmond Pro <span class="team-heart" style="display:inline-flex; vertical-align:middle;"><svg width="20" height="20" viewBox="0 0 24 24" fill="#38bdf8"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg></span> México</h2>
  ...
  // Remove automatic initTeamMap, export it so the modal can trigger it when visible
}
...
function onCardClick(id) {
  ...
  if (mapEl && window.innerWidth < 700) {
    const mapModalContent = document.querySelector('#map-modal .modal');
    if (mapModalContent) {
      mapModalContent.scrollTo({ top: mapEl.offsetTop - 50, behavior: 'smooth' });
    } else {
...
window.initTeamMap = initTeamMap; // Exported to be called by app.js
