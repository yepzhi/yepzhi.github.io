...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            "eco.card1_desc": "stemOS is an AI-powered Learning Experience Platform (LXP) that delivers personalized STEM and technical skill learning pathways through industry-aligned micro-credentials. Built to bridge the STEM talent and technical skills gap.",
