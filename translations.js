const translations = {
    es: {
        ...
        profile: {
            bio: "<strong>Líder en Alianzas y Producto | EdTech, Plataformas Digitales ⚡ Infraestructura local GenAI.</strong><br>+15 años impulsando crecimiento en empresas como <strong>Apple</strong>, <strong>PepsiCo</strong>, <strong>AVIS</strong> y <strong>Santillana/Richmond</strong>, a través de alianzas estratégicas, redes de distribución y relaciones comerciales de largo plazo.<br><br>MBA con especialización en Finanzas. Experiencia full cycle CX/UX, analítica de datos.<br>Certificación en Data Science y Agile Systems for Product Management, University of Maryland ✨<br>🇺🇸 Inglés nivel B2 (CEFR), certificado por ETS.<br><br>💻 Desarrollamos <a href=\"https://yepzhi.com/stemos/\" target=\"_blank\"><strong>stemOS</strong></a>: una plataforma LXP NextGen potenciada con IA en Local.<br>También lidero <a href=\"https://yepzhi.com/jsweb/\" target=\"_blank\"><strong>JóvenesSTEM 🌎</strong></a>, iniciativa social que acerca ciencia, tecnología e innovación a las nuevas generaciones."
        },
        links: {
